...
$JAVA_HOME20/bin/javac -target 17 -source 17 -d $TARGET/main `find src/main/java -type f`
$JAVA_HOME20/bin/java -classpath $TARGET/main org.frgaal.tests.patterns.Test | tee $TARGET/expected-output || exit 1
