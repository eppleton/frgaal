...
$JAVA_HOME20/bin/java -jar $COMPILER -target 8 -d $TARGET/test -classpath $TARGET/main -processor org.frgaal.tests.sourceversion.api.AP `find src/test/java -type f` >$TARGET/output19
