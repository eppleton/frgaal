...
if java "-Djava.home.8=$JAVA_HOME8" "-Djava.home.current=$JAVA_HOME19" -classpath $BUILD_LIBS/junit-4.13.2.jar:$BUILD_LIBS/hamcrest-core-1.3.jar:$COMPILER:$BUILD_CLASSES org.junit.runner.JUnitCore $TESTS; then
    echo "OK."
    exit 0
else
    echo "Failure"
