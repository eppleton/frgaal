...
public class SealedTest extends TestBase {
    ...
    public void testCanCompileSealedToJDK8() throws Exception {
        Path sealedSource = writeFile("Test.java",
                                      ...
                                      """);
        runCompareTest("-d", classDir.toString(), "-source", "19", "-target", "8", sealedSource.toString());
    }
    ...
    public void testViolation1() throws Exception {
        Path baseSource = writeFile("Base.java",
                                    ...
                                    """);
        this.compile("-d", classDir.toString(), "-source", "19", "-target", "8", baseSource.toString())
            .assertOutput(0, "");
        Path extraSource = writeFile("Extra.java",
                                     ...
                                     """);
        this.compile("-XDrawDiagnostics", "-d", classDir.toString(), "-classpath", classDir.toString(), "-source", "19", "-target", "8", extraSource.toString())
            .assertOutput(1,
                          """
    ...
    public void testViolation2() throws Exception {
        ...
        Path extraSource = writeFile("Extra.java",
                                     ...
                                     """);
        this.compile("-d", classDir.toString(), "-classpath", classDir.toString(), "-source", "19", "-target", "8", extraSource.toString())
            .assertOutput(0, "");
        /**/ baseSource = writeFile("Base.java",
                                    ...
                                    """);
        this.compile("-d", classDir.toString(), "-classpath", classDir.toString(), "-source", "19", "-target", "8", baseSource.toString())
            .assertOutput(0, "");
        buildJar();
        this.run(jdk8,
                 "p.Base")
