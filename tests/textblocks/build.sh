...
$JAVA_HOME18/bin/javac -target 16 -source 16 -d $TARGET/main `find src/main/java -type f`
$JAVA_HOME18/bin/java -classpath $TARGET/main org.frgaal.tests.textblocks.Test | tee $TARGET/expected-output || exit 1
