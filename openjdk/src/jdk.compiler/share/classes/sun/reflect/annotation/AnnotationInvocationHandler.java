...
//                (AnnotationInvocationHandler.class, "memberValues");
        ...
        static void setType(AnnotationInvocationHandler o,
            ...
            try {
                Field f = AnnotationInvocationHandler.class.getDeclaredField("type");
        ...
        static void setMemberValues(AnnotationInvocationHandler o,
            ...
            try {
                Field f = AnnotationInvocationHandler.class.getDeclaredField("memberValues");
                f.setAccessible(true);
                f.set(o, memberValues);
            } catch (ReflectiveOperationException | SecurityException ex) {
                throw new IllegalStateException();
            }
        }
